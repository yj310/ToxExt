...
D3DXVECTOR2 SecondGamePage::GetEnemyPos()
{
	int x;
	int y;
	while (true)
...
void SecondGamePage::Load()
{
	...
	mCreateTexture("resource/image/mask2.png", basicMaskTex);
...
void SecondGamePage::GetKeyInput()
{
	// space
...
void SecondGamePage::PlayerMove(D3DXVECTOR2 dir)
{
...
bool SecondGamePage::isEmpty(int i)
{
...
void SecondGamePage::GetPersent()
{
	MaxLand = 0;
	myLand = 0;
...
void SecondGamePage::PlayerMoveFail()
{
	moveCount = 0;
